...
/* harmony import */ var _sortList__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sortList */ "./resources/js/app/sortList.js");
...
(function () {
  ...
  function init(el) {
    ...
    new list_js__WEBPACK_IMPORTED_MODULE_0___default.a(el, options);
  } //
  // Events
  //


  if (typeof list_js__WEBPACK_IMPORTED_MODULE_0___default.a !== 'undefined') {
    if (toggle) {
